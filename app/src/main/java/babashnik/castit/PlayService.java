...
public class PlayService extends Service {
    ...
    private void showNotification(int pos) {
        ...
        notificationIntent.setAction("babashnik.castit.action.main");
        ...
        playIntent.setAction("babashnik.castit.action.play");
        PendingIntent pplayIntent = PendingIntent.getService(this, 0,
                playIntent, 0);

        Intent closeIntent = new Intent(this, PlayService.class);
        closeIntent.setAction("babashnik.castit.action.stopforeground");
